"""
core.sglword -- word-level alignment (jieba segmentation + NW).

    >>> from core.sglword import word_align
...
from core._types import AlignedPair, CharDiff, WordDiffBlock, WordDiffResult
